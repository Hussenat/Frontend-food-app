...
const BlogDetail = () => {
  ...
  const fetchDetails = async () => {
    const res = await axios.get(`https://food-blog-app-backend.cyclic.app/api/blog/${id}`).catch(error => console.log(error))
  ...
  const sendRequest = async () => {
    const res =  await axios.put(`https://food-blog-app-backend.cyclic.app/blog/update/${id}`, {
      title: inputs.title,
